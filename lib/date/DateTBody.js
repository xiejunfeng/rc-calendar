...
var DateTBody = _react2.default.createClass({
  ...
  render: function render() {
    ...
    if (props.defaultPickerTime) {
      var defaultPickerTime = props.defaultPickerTime.split(":");
      value.setTime(new Date().setHours(parseInt(defaultPickerTime[0]), parseInt(defaultPickerTime[1]), parseInt(defaultPickerTime[2])));
    }
